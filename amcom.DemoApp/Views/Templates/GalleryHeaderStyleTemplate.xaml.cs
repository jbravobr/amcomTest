...
{
	public partial class GalleryHeaderStyleTemplate : ContentView
	{
		public GalleryHeaderStyleTemplate()
		{
			InitializeComponent();
		}
		...
		public static BindableProperty TextProperty =
			BindableProperty.Create(
				nameof(Text),
				typeof(string),
				typeof(GalleryHeaderStyleTemplate),
				string.Empty,
				defaultBindingMode: BindingMode.OneWay,
				propertyChanged: (bindable, oldValue, newValue) =>
		{
			var ctrl = (GalleryHeaderStyleTemplate)bindable;
